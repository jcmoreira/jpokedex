...
public enum Pokemon {
    ...
    static {
        ...
        SNORLAX.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, EARTHQUAKE), MovesetRating.of("C6", "C7"));
        SNORLAX.movesetRanks.put(Moveset.of(LICK, EARTHQUAKE), MovesetRating.of("C5", "D8"));
        ...
        SNORLAX.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, HEAVY_SLAM), MovesetRating.of(null, "B3"));
        ...
        SNORLAX.movesetRanks.put(Moveset.of(LICK, HEAVY_SLAM), MovesetRating.of(null, "B6"));
        ...
        DRAGONITE.movesetRanks.put(Moveset.of(STEEL_WING, DRAGON_PULSE), MovesetRating.of("C5", "B6"));
        DRAGONITE.movesetRanks.put(Moveset.of(DRAGON_BREATH, DRAGON_PULSE), MovesetRating.of("B2", "C9"));
        DRAGONITE.movesetRanks.put(Moveset.of(DRAGON_TAIL, HYPER_BEAM), MovesetRating.of(null, "B3"));
        DRAGONITE.movesetRanks.put(Moveset.of(DRAGON_TAIL, HURRICANE), MovesetRating.of(null, "A2"));
        DRAGONITE.movesetRanks.put(Moveset.of(STEEL_WING, DRAGON_CLAW), MovesetRating.of("C4", "B7"));
        DRAGONITE.movesetRanks.put(Moveset.of(DRAGON_BREATH, HYPER_BEAM), MovesetRating.of("B3", "D11"));
        DRAGONITE.movesetRanks.put(Moveset.of(DRAGON_TAIL, OUTRAGE), MovesetRating.of(null, "A1"));
        DRAGONITE.movesetRanks.put(Moveset.of(STEEL_WING, HYPER_BEAM), MovesetRating.of("D6", "C8"));
        DRAGONITE.movesetRanks.put(Moveset.of(STEEL_WING, OUTRAGE), MovesetRating.of(null, "B4"));
        DRAGONITE.movesetRanks.put(Moveset.of(DRAGON_BREATH, DRAGON_CLAW), MovesetRating.of("A1", "C10"));
        DRAGONITE.movesetRanks.put(Moveset.of(STEEL_WING, HURRICANE), MovesetRating.of(null, "B5"));
        ...
        ESPEON.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, FUTURE_SIGHT), MovesetRating.of(null, "C4"));
        ESPEON.movesetRanks.put(Moveset.of(CONFUSION, Move.PSYCHIC), MovesetRating.of(null, "D5"));
        ESPEON.movesetRanks.put(Moveset.of(CONFUSION, PSYBEAM), MovesetRating.of(null, "A1"));
        ESPEON.movesetRanks.put(Moveset.of(CONFUSION, FUTURE_SIGHT), MovesetRating.of(null, "C3"));
        ESPEON.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, PSYBEAM), MovesetRating.of(null, "B2"));
        ESPEON.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, Move.PSYCHIC), MovesetRating.of(null, "D6"));
        ...
        STEELIX.movesetRanks.put(Moveset.of(DRAGON_TAIL, CRUNCH), MovesetRating.of(null, "B2"));
        STEELIX.movesetRanks.put(Moveset.of(IRON_TAIL, HEAVY_SLAM), MovesetRating.of(null, "C5"));
        STEELIX.movesetRanks.put(Moveset.of(DRAGON_TAIL, HEAVY_SLAM), MovesetRating.of(null, "C6"));
        STEELIX.movesetRanks.put(Moveset.of(IRON_TAIL, CRUNCH), MovesetRating.of(null, "A1"));
        STEELIX.movesetRanks.put(Moveset.of(DRAGON_TAIL, EARTHQUAKE), MovesetRating.of(null, "B4"));
        STEELIX.movesetRanks.put(Moveset.of(IRON_TAIL, EARTHQUAKE), MovesetRating.of(null, "B3"));
        ...
        DONPHAN.movesetRanks.put(Moveset.of(COUNTER, EARTHQUAKE), MovesetRating.of(null, "D5"));
        DONPHAN.movesetRanks.put(Moveset.of(TACKLE, PLAY_ROUGH), MovesetRating.of(null, "B2"));
        DONPHAN.movesetRanks.put(Moveset.of(COUNTER, HEAVY_SLAM), MovesetRating.of(null, "B3"));
        DONPHAN.movesetRanks.put(Moveset.of(COUNTER, PLAY_ROUGH), MovesetRating.of(null, "A1"));
        DONPHAN.movesetRanks.put(Moveset.of(TACKLE, EARTHQUAKE), MovesetRating.of(null, "F6"));
        DONPHAN.movesetRanks.put(Moveset.of(TACKLE, HEAVY_SLAM), MovesetRating.of(null, "C4"));
        ...
        TYROGUE.movesetRanks.put(Moveset.of(ROCK_SMASH, BRICK_BREAK), MovesetRating.of(null, "A1"));
        TYROGUE.movesetRanks.put(Moveset.of(LOW_KICK, BRICK_BREAK), MovesetRating.of("A1", null));
        ...
        BLISSEY.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, DAZZLING_GLEAM), MovesetRating.of(null, "A1"));
        BLISSEY.movesetRanks.put(Moveset.of(POUND, Move.PSYCHIC), MovesetRating.of(null, "D5"));
        BLISSEY.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, HYPER_BEAM), MovesetRating.of(null, "B3"));
        BLISSEY.movesetRanks.put(Moveset.of(ZEN_HEADBUTT, Move.PSYCHIC), MovesetRating.of(null, "D6"));
